    ...
    <SafeAreaView style={styles.spotterProfile}>
      <View style={styles.view}>
        ...
        <View style={[styles.spotterProfilePicture, styles.swipeUpIconPosition]}>
          <Image style={styles.fa6deaa7b10361d6d6c42a4db9368Icon} resizeMode="cover" source={require("../../assets/652fa6deaa7b10361d6d6c42a4db9368 1.png")} />
              <View style={[styles.name, styles.iconLayout]}>
                <Text style={styles.joshHanley}>Josh Hanley</Text>
              </View>
        ...
        <View style={[styles.profileHeader, styles.profileLayout]}>
          ...
          <LinearGradient style={[styles.userStatus1, styles.userPosition]} locations={[0,1]} colors={['#ff00ff','#2a2882']} useAngle={true} angle={180}>
