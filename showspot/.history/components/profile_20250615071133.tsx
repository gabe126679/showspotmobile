...
const Profile = () => {
  ...
  const { name, profilePictureUrl } = useUser();
    ...
    <SafeAreaView style={styles.spotterProfile}>
      <View style={styles.view}>
        ...
        <View style={[styles.spotterProfilePicture, styles.swipeUpIconPosition]}>
          {profilePictureUrl ? (
            <Image source={{ uri: profilePictureUrl }} style={styles.fa6deaa7b10361d6d6c42a4db9368Icon} />
          ) : (
            <Image
              source={require("../../assets/652fa6deaa7b10361d6d6c42a4db9368 1.png")}
              style={styles.fa6deaa7b10361d6d6c42a4db9368Icon}
            />
          )}
          <View style={[styles.name, styles.iconLayout]}>
            <Text style={styles.joshHanley}>{name}</Text>
          </View>
        ...
        <View style={[styles.footerProfile, styles.profileLayout]}>
          <TouchableOpacity style={[styles.homeIcon, styles.iconLayout]} onPress={() => navigation.navigate("Home")}>
            <HomeIcon width={60} height={60} />
          </TouchableOpacity>
          <TouchableOpacity style={[styles.searchIcon, styles.iconLayout]} onPress={() => navigation.navigate("Search")}>
            <SearchIcon width={60} height={60} />
          </TouchableOpacity>
          <TouchableOpacity style={[styles.createIcon, styles.iconLayout]} onPress={() => navigation.navigate("Create")}>
            <CreateIcon width={60} height={60} />
          </TouchableOpacity>
          <TouchableOpacity style={[styles.playerIcon, styles.iconLayout]} onPress={() => navigation.navigate("Player")}>
