      ...
      <View style={styles.view}>
        ...
        <View style={[styles.spotterProfilePicture, styles.swipeUpIconPosition]}>
          {profileImage ? (
            ...
            <View style={[styles.placeholderImage, styles.fa6deaa7b10361d6d6c42a4db9368Icon]} />
          )}
        ...
        <View style={[styles.footerProfile, styles.profileLayout]}>
          <TouchableOpacity onPress={() => navigation.navigate("Home" as never)} style={[styles.homeIcon, styles.iconLayout]}>
